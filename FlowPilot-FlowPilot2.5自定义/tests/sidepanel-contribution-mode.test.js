...
test('contribution mode manager keeps header entry disabled while panel actions still work', async () => {
  ...
  assert.deepStrictEqual(openedUrls, ['https://flowpilot.qlhazycoder.top/upload']);
  ...
  assert.deepStrictEqual(
    ...
    ['POLL_FLOW_CONTRIBUTION_STATUS', 'SET_ACCOUNT_CONTRIBUTION_MODE']
  );
  assert.deepStrictEqual(
